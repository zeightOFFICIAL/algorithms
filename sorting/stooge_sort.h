...
template <typename T>
static void StoogeSort(T *array, unsigned long length, bool order = true);
template <typename T>
static void StoogeSortRanged(T *array, unsigned long start_point,
                             unsigned long end_point, bool order);
...
*/
template <typename T>
static void StoogeSort(T *array, unsigned long length, bool order) {
  length--;
