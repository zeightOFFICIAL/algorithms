...
std::vector<unsigned long> KnuthMorrisPratt(std::string text,
                                            std::string pattern);
void LongestPrefixSufix(std::string pattern, unsigned long pattern_length,
                        unsigned long *table, unsigned long text_length);
