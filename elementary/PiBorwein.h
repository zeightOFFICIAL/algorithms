...
/*
  ...
  -Returns pi number B.
*/
long double piBorweinQuadratic(unsigned int precisionRequired);
/*
  (unsigned int A) -> (long double B)
  Finds 1/pi number B with precision of A.
  -Returns 1/pi number B.
*/
long double piBorweinCubic(unsigned int precisionRequired);
/*
  (unsigned int A) -> (long double B)
  Finds 1/pi number B with precision of A.
  -Returns 1/pi number B.
*/
long double piBorweinQuartic(unsigned int precisionRequired);
